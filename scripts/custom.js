      ...
      selectField.forEach((el) =>
        el.addEventListener("change", (e) => {
          if (el.value !== "default") {
            ...
            var invalidEl =
              el.parentElement.querySelectorAll(".invalid, em, span")[0];
            if (invalidEl) invalidEl.classList.add("disabled");
          }
          if (el.value == "default") {
            var spanEl =
              el.parentElement.querySelectorAll("span, .valid, em")[0];
      ...
      function geoLocate() {
        ...
        function success(position) {
          ...
          document
            ...
            .setAttribute("href", mapLinkNewAPI);
          document
            .getElementsByClassName("location-button")[0]
            .classList.remove("disabled");
        }
      ...
      searchHeader.forEach((el) =>
        el.addEventListener("click", (event) => {
          ...
          document
            ...
            .classList.toggle("header-search-active");
        })
      );
    }
